            ...
            <li>
              <ul role="list" class="-mx-2 space-y-1">
                <li>
                  ...
                  <a href="#" class="bg-gray-50 text-app-900 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                ...
                <li>
                  <a href="#" class="text-white hover:text-app-900 hover:bg-gray-50 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
